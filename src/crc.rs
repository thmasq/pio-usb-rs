//! USB CRC5 and CRC16 calculation utilities.

/// Lookup table for USB CRC5.
const CRC5_TBL: [u8; 32] = [
...
/// Calculates the CRC5-USB for an 11-bit data value (e.g., Token Packets).
///
...
/// Lookup table for USB CRC16.
const CRC16_TBL: [u16; 256] = [
